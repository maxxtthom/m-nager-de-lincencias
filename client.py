...
if premium == True:
    # DENTRO DE ESTE PONER TODO EL CODIGO DE SCRIPT OJO SE RECOMIENDO OFUSCACION DE CODIGO PARA MAYOR SEGURIDAD DEL CODIGO POR EVITAR POSIBLES DESINCRIPTADORES
   activado = """
